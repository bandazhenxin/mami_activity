<template>
  <div class="rice-noodles-render basic-render">
    <div class="item1">
      <a href="http://m.guojimami.com/Supersale.php"><img src="@/assets/liangfan0826_26.jpg"  alt="拼团"/></a>
    </div>
    <div class="content">
